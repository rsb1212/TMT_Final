    ...
    <div style={{ marginTop: 4 }}>
      ...
      {pendingFiles.length > 0 && (
        <div style={{
          ...
          {pendingFiles.map((f, i) => (<div key={f.id || f.name || i} style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <div className="form-group">
              ...
              <select value={form.environment}
                ...
                {ENVS.map(env => <option key={env.value} value={env.value}>{env.label}</option>)}
              </select>
            </div>
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Record who tested what — pass/fail/defect per test case</p>
        </div>
