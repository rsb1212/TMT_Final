...
const STATUSES = [
  ...
  'DEFECT_RAISED','SIGNED_OFF','RETEST','NA','NOT_RELEASED',
  'RELEASE_REQUESTED','RELEASED','DEPRECATED',
];
        ...
        <form onSubmit={handleSave}>
          ...
          <div style={{ marginTop: 4 }}>
            ...
            <div style={{ maxHeight: 260, overflowY: 'auto',
              ...
              {form.steps.map((s, i) => (<div key={s.id || s.name || i} style={{ display: 'grid',
          ...
          <div>
            ...
            {importResult.errors?.length > 0 && (
              <div style={{ maxHeight: 200, overflowY: 'auto',
                ...
                {importResult.errors.map((e, i) => (<div key={e.id || e.name || i} style={{ fontSize: 12, color: 'var(--red)',
...
export default function TestCasesPage() {
  ...
  const canForward= ['TESTER','MANAGER','ADMIN'].includes(user?.role);
                  ...
                  <tr key={tc.id} style={{ cursor: 'pointer' }}
                    ...
                    <td onClick={e => e.stopPropagation()}>
                      <div style={{ display: 'flex', gap: 5 }}>
                        ...
                        {/* Forward to SME */}
                        {canForward && ['DRAFT','PASSED'].includes(tc.status) && (
                          <button className="btn btn-secondary btn-sm"
                            onClick={e => handleForwardSME(tc.id, e)} title="Send to SME">
                            <Send size={13} />
                          </button>
                        )}
                        {/* Delete */}
