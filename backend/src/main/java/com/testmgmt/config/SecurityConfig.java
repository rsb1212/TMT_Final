...
public class SecurityConfig {
    ...
    private final com.testmgmt.security.RateLimitFilter rateLimitFilter;
        ...
        http
            ...
            .headers(headers -> headers
                ...
                .contentSecurityPolicy(csp -> csp
                    .policyDirectives("frame-ancestors 'none'; default-src 'self'"))
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/v1/testcases/*/forward-sme").hasAnyRole("TESTER","MANAGER","ADMIN")
                ...
                .requestMatchers("/api/v1/calls/**").hasAnyRole("MANAGER","ADMIN","SME","TESTER")
                ...
                // Central Repository
                .requestMatchers("/api/v1/repository/**").hasAnyRole("TESTER","MANAGER","ADMIN","SME")

                // Release Management
                .requestMatchers(HttpMethod.POST,  "/api/v1/releases/testcases/*/request").hasAnyRole("TESTER","MANAGER","ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/api/v1/releases/*/action").hasAnyRole("MANAGER","ADMIN")
                .requestMatchers(HttpMethod.GET,   "/api/v1/releases/pending").hasAnyRole("MANAGER","ADMIN")
                .requestMatchers(HttpMethod.GET,   "/api/v1/releases/**").authenticated()
