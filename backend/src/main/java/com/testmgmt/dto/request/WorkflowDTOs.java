...
public class WorkflowDTOs {
    ...
    @Data public static class ReleaseTestCaseRequest {
        @NotNull  private com.testmgmt.enums.ReleaseReason reason;
        /** Required only when reason == OTHER */
        private String reasonDetail;
    }

    @Data public static class ActionReleaseRequest {
        /** APPROVED or REJECTED */
        @NotBlank private String action;
        private String managerNote;
        /** If APPROVED — optional immediate reassignment to another tester */
